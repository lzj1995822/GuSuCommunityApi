package com.cloudkeeper.leasing.identity.dto.associationmanagement;
 ...
 * @author ZLA
 */
@ApiModel(value = "协会管理 查询DTO", description = "协会管理 查询DTO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class AssociationManagementSearchable extends BaseSearchable {
