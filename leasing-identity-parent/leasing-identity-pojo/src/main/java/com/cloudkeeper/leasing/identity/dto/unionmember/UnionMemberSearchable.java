package com.cloudkeeper.leasing.identity.dto.unionmember;
 ...
 * @author lxw
 */
@ApiModel(value = "工会会员 查询DTO", description = "工会会员 查询DTO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class UnionMemberSearchable extends BaseSearchable {
