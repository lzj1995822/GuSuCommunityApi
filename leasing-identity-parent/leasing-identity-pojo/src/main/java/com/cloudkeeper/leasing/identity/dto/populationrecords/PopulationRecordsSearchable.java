package com.cloudkeeper.leasing.identity.dto.populationrecords;
 ...
 * @author lxw
 */
@ApiModel(value = "人口档案 查询DTO", description = "人口档案 查询DTO")
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class PopulationRecordsSearchable extends BaseSearchable {
