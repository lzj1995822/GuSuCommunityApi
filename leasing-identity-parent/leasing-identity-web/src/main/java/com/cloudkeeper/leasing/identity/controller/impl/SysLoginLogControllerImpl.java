...
public class SysLoginLogControllerImpl implements SysLoginLogController {
    ...
    @Override
    public Result<SysLoginLogVO> findOne(@ApiParam(value = "类属性配置id", required = true) @PathVariable String id) {
    ...
    @Override
    public Result<SysLoginLogVO> add(@ApiParam(value = "类属性配置 DTO", required = true) @RequestBody @Validated SysLoginLogDTO sysLoginLogDTO) {
    ...
    @Override
    public Result<SysLoginLogVO> update(@ApiParam(value = "类属性配置id", required = true) @PathVariable String id,
    ...
    @Override
    public Result<List<SysLoginLogVO>> list(@ApiParam(value = "类属性配置查询条件", required = true) @RequestBody SysLoginLogSearchable sysLoginLogSearchable,
    ...
    @Override
    public Result<Page<SysLoginLogVO>> page(@ApiParam(value = "类属性配置查询条件", required = true) @RequestBody SysLoginLogSearchable sysLoginLogSearchable,
